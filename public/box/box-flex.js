...
function skrollrSetup() {
    ...
    // section-wrap
    if(viewportWidth<=970) { // disable on mobile
    ...
    if(viewportWidth<=970) pins = document.querySelectorAll('.is-wrapper:not(.is-edit) .section-pin:not(.m-skrollrr-off):not(.m-pin-off)'); // do not apply skrollrr if .m-skrollrr-off found on mobile
    ...
    if(viewportWidth<=970) pins = document.querySelectorAll('.is-wrapper:not(.is-edit) .section-pin:not(.m-skrollrr-off):not(.m-pin-off)');
